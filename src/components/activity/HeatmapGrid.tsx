import { DayActivity } from "@/app/actions/activity";
import { format, parseISO, getDay } from "date-fns";
import { motion } from "framer-motion";

export function HeatmapGrid({ data }: { data: DayActivity[] }) {
  // Group by weeks
  // A week array will hold 7 days. If a year doesn't start on Sunday, we pad the first week.
  ...
  return (
    <div className="w-full overflow-x-auto custom-scrollbar pb-4">
      ...
      <div className="mt-4 flex items-center justify-between text-xs text-text-secondary">
        <a href="https://docs.github.com/en/account-and-profile/setting-up-and-managing-your-github-profile/managing-contribution-settings-on-your-profile/why-are-my-contributions-not-showing-up-on-my-profile" className="hover:text-primary transition-colors">
