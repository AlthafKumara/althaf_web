/**
 * @fileoverview Activity Loading Skeleton
 *
 * A placeholder UI rendered while the Activity Dashboard data is being
 * fetched. Uses `animate-pulse` to indicate loading state. This component
 * is purely presentational — it receives no props or data.
 *
 * @module features/activity/views/ActivitySkeleton
 */

import { FaGithub, FaGitlab } from "react-icons/fa";

/**
 * Renders a full-section loading skeleton for the Activity Dashboard.
 * Mimics the layout of the actual dashboard to prevent layout shift.
 */
        ...
        <div className="bg-surface border border-neutral-800 rounded-2xl p-6 md:p-8 animate-pulse">
          ...
          <div className="space-y-4">
            {[1, 2, 3, 4, 5].map((i) => (
              <div
                key={i}
                className="flex gap-4 p-4 rounded-xl border border-neutral-800"
              >
