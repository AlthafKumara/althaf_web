/**
 * @fileoverview Hero Section View
 *
 * The high-impact landing section displayed at the top of the homepage.
 * Contains the developer's value proposition, CTAs (View Projects + Resume),
 * and a visual element with floating tech badges.
 *
 * This is a **Client Component** because it uses Framer Motion animations.
 *
 * @module features/home/views/Hero
 */
...
/**
 * Renders the hero section with animated entrance effects.
 *
 * Layout:
 * - **Left**: Text content (badge, heading, description, CTAs)
 * - **Right**: Visual placeholder with floating technology badges
 */
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-text-primary leading-tight">
            ...
            Apps & Scalable Systems.
          </h1>

          <p className="text-lg md:text-xl text-text-secondary max-w-2xl mx-auto md:mx-0 leading-relaxed">
            I am a Software Engineer specializing in Flutter & Dart.
            Transforming complex requirements into high-performance, functional
            applications with deep integrations like Supabase, Docker, and REST
            APIs.
          </p>
