/**
 * @fileoverview About Section View
 *
 * Renders the "Background & Philosophy" section on the homepage.
 * Displays a summary of the developer's approach and three highlight
 * cards (Mobile First, Robust Backend, Modern DevOps).
 *
 * This is a **Client Component** because it uses Framer Motion
 * for scroll-triggered entrance animations.
 *
 * @module features/home/views/About
 */
...
/** Configuration for the three expertise highlight cards. */
const HIGHLIGHTS = [
  {
...
/**
 * Renders the about section with animated expertise cards.
 *
 * Contains:
 * - A centered paragraph with the developer's philosophy
 * - A 3-column grid of expertise highlights with icons
 */
export default function About() {
  return (
    <section
      id="about"
      className="py-24 bg-surface/50 border-t border-b border-neutral-800"
    >
      <div className="container mx-auto px-4 md:px-8">
        ...
        >
          ...
          <p className="text-text-secondary text-lg leading-relaxed">
            I approach mobile and full-stack development as an ecosystem. It's
            not just about building a beautiful UI, but ensuring the data layer,
            backend logic, and user experience work together seamlessly. My
            workflow often integrates WSL2, Docker, and modern CI/CD to maintain
