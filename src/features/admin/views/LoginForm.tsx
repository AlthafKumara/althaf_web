/**
 * @fileoverview Login Form View
 *
 * Renders the admin login form UI. All authentication logic is handled
 * by the `useAuthController` hook — this component is purely presentational.
 *
 * Features:
 ...
 *
 * @module features/admin/views/LoginForm
 */
...
/**
 * Renders the admin login page form.
 *
 * Layout:
